...
- If the action fails, use **Teacher Tools > Open Automation Log** for the persistent error. Do not share a handoff marker outside your authorized student-data systems.
